...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/mini_ids/comparator.sch" comparator.vf
...
module comparator(a, 
   ...
   COMP8_MXILINX_comparator XLXI_1 (.A(a[7:0]), 
                                    .B(b[7:0]), 
                                    .EQ(XLXN_29));
   ...
   COMP8_MXILINX_comparator XLXI_3 (.A(a[23:16]), 
                                    .B(b[23:16]), 
                                    .EQ(XLXN_27));
   ...
   COMP8_MXILINX_comparator XLXI_6 (.A(a[47:40]), 
                                    .B(b[47:40]), 
                                    .EQ(XLXN_24));
   // synthesis attribute HU_SET of XLXI_6 is "XLXI_6_5"
   COMP8_MXILINX_comparator XLXI_7 (.A(a[55:48]), 
                                    .B(b[55:48]), 
                                    .EQ(XLXN_33));
   // synthesis attribute HU_SET of XLXI_7 is "XLXI_7_6"
   AND7_MXILINX_comparator XLXI_8 (.I0(XLXN_34), 
                                   .I1(XLXN_37), 
                                   .I2(XLXN_36), 
                                   .I3(XLXN_35), 
                                   .I4(XLXN_32), 
   ...
   OR2B1 XLXI_9 (.I0(amask[0]), 
                 .I1(XLXN_29), 
                 .O(XLXN_30));
   OR2B1 XLXI_10 (.I0(amask[1]), 
                  .I1(XLXN_28), 
                  .O(XLXN_31));
   OR2B1 XLXI_11 (.I0(amask[2]), 
                  .I1(XLXN_27), 
                  .O(XLXN_32));
